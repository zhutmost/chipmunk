...
trait TestRunner {
  def runTester[T <: RawModule, U](t: => T, additionalVResources: Seq[String] = Seq())(
    testbench: SimulatedModule[T] => U
  ): Boolean
}
...
//trait ChipmunkTestRunner {

//
//  /** Compiles a Chisel Module to Verilog NOTE: This uses the "test_run_dir" as the default directory for generated
//    * code.
//    * @param t
//    *   the generator for the module
//    * @return
//    *   the Verilog code as a string.
//    */
...
//  /** Compiles a Chisel Module to FIRRTL NOTE: This uses the "test_run_dir" as the default directory for generated code.
//    * @param t
//    *   the generator for the module
//    * @return
//    *   The FIRRTL Circuit and Annotations _before_ FIRRTL compilation
//    */
...
abstract class ChiselPropSpec extends AnyPropSpec with ChipmunkTestRunner with ScalaCheckPropertyChecks with Matchers {
 ...
 *   some Scala code
 * @return
 *   a tuple containing LOGGED, and what the thunk returns
 */
 ...
 * @param gen
 *   function to generate a Chisel module
 * @param f
 *   a function to check the Chisel module
 * @tparam T
 *   the Chisel module class
 */
 ...
 *   some code to run
 * @tparam A
 *   the type of the exception to extract
 * @return
 *   nothing
 */
