...
class RegBankSpec extends ChipmunkFlatSpec with VerilatorTestRunner {
  ...
  it should "allow field access by either frontdoor or backdoor" in {
    ...
    compiled.runSim { dut =>
      ...
      dut.io.access.wr.req.valid #= true
      dut.io.access.wr.req.bits.addr #= 1.U
      dut.io.access.wr.req.bits.data #= 0x1234.U
      dut.io.fields("R2_F1").value expect 0xab.U
      dut.clock.step()
      dut.io.access.wr.req.valid #= false
      dut.io.access.rd.req.valid #= true
      dut.io.access.rd.req.bits.addr #= 1.U
      dut.io.fields("R2_F1").value expect 0x34.U
      dut.io.fields("R2_F2").value expect 0x12.U
      dut.clock.step()
      dut.io.access.rd.resp.bits.data expect 0x1234.U
    }
  }
  ...
  it should "allow field frontdoor writing with mask" in {
    ...
    compiled.runSim { dut =>
      ...
      dut.clock.step()
      dut.io.access.wr.req.valid #= true
      dut.io.access.wr.req.bits.addr #= 0.U
      dut.io.access.wr.req.bits.mask.get #= 0x1.U
      dut.io.access.wr.req.bits.data #= 0x5678.U
      dut.io.fields("R1").value expect 0x1234.U
      dut.clock.step()
  ...
  it should "update field values according to access types" in {
    ...
    compiled.runSim { dut =>
      ...
      dut.io.access.wr.req.valid #= false
      dut.io.access.rd.req.valid #= true
      dut.io.access.rd.req.bits.addr #= 0.U
      dut.io.fields("R1").value expect 0x00ff.U
      dut.clock.step()
      dut.io.access.rd.req.valid #= false
      dut.io.access.wr.req.valid #= true
      dut.io.access.wr.req.bits.addr #= 1.U
      dut.io.access.wr.req.bits.mask.get #= 0x3.U
      dut.io.access.wr.req.bits.data #= 0x5555.U
      dut.io.fields("R2").value expect 0.U
      dut.clock.step()
      dut.io.access.wr.req.bits.addr #= 2.U
      dut.io.access.wr.req.bits.data #= 0x5555.U
